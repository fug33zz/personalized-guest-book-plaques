...
export default function App(){
  ...
  return <main className="app-shell">
    <header className="masthead"><a className="brand" href="#editor" aria-label="Plaque studio home"><span>Guest Book</span><strong>Plaque Studio</strong></a><p>Wedding collection · Ten templates</p></header>
...
const templateMarks={heritage:'♥',botanical:'❧',arch:'∩',formal:'◇',minimal:'Aa',vintage:'❦',wreath:'○',deco:'◆',scalloped:'∿',cameo:'◯'} as const;
