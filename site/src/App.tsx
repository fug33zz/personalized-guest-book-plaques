  ...
  return <main className="app-shell">
    ...
    <section className="editor" id="editor">
      <aside className="controls" aria-label="Plaque controls">
        ...
        <fieldset><legend>Lettering style</legend><div className="segmented">{(['elegant','modern'] as FontId[]).map((font)=><button type="button" className={design.font===font?'selected':''} onClick={()=>update('font',font)} key={font}>{font==='elegant'?'Elegant serif':'Modern clean'}</button>)}</div></fieldset>
